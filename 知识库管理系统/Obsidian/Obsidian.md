...
如何开始创建一个知识网络？请先从创建一条[[./插件/内部链接|内部链接]]内部链接开始！
...
这正是 Obsidian 的价值所在，也是我们推荐使用[[./插件/内部链接|内部链接]]和[[./插件/关系图谱|关系图谱]]以及其他诸多功能的原因。
...
- 如果你希望记录课堂笔记，那么[[./插件/录音机|录音机]]和 LaTeX 公式或许会很有帮助。
- 如果你希望记录工作笔记，[[./插件/幻灯片|幻灯片]]和[[./插件/反向链接|反向链接]]或许能助你一臂之力 。
- 如果你是一个科研工作者，[[./插件/关系图谱|关系图谱]]和[[./插件/字数统计|字数统计]]将是你必不可少的利器。

我们不期望插件能成为解决所有问题的灵丹妙药，但它们确实比那些希望集成所有功能的单一解决方案更贴近我们的个性化需求，也使界面更加简洁。

现在，我们支持自定义CSS并且开发了[[./插件/插件API|插件API]]，这将使 Obsidian 能支持那些更小众的使用方法，更加个性化。
